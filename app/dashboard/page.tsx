      ...
      <main className="w-full mx-auto flex min-h-screen max-w-[1440px] gap-0 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <section className="flex-1">
          <div className="flex flex-col gap-6">
            <header className="flex flex-wrap items-center justify-between gap-3 rounded-none bg-white px-4 py-4 shadow-none">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_30px_80px_rgba(15,23,42,0.08)] sm:p-8">
              ...
              <div className="grid gap-5 lg:grid-cols-[1.8fr_0.6fr]">
                <div className="rounded-[2rem] border border-slate-200 bg-slate-50 p-6">
                  <div className="flex flex-col items-center justify-center gap-6 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                    <div className="relative mx-auto w-full max-w-[420px] overflow-hidden rounded-[2rem] bg-white p-6 shadow-lg shadow-slate-200/40 aspect-square sm:max-w-[420px]">
                ...
                <div className="grid gap-5">
                  ...
                  <div className="rounded-[2rem] border border-slate-200 bg-slate-50 p-6 aspect-square">
                    ...
                    <div className="mt-6 grid h-full gap-4">
            ...
            <div className="grid gap-6 xl:grid-cols-[0.85fr_0.45fr]">
              ...
              <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_30px_80px_rgba(15,23,42,0.08)] xl:aspect-square">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm uppercase tracking-[0.35em] text-slate-500">Notifications</p>
                    <h3 className="mt-3 text-2xl font-semibold text-slate-950">Alerts</h3>
